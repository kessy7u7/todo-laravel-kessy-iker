                    ...
                    <div class="text-lg font-bold flex items-center justify-between">
                        ...
                        <div class="flex items-center">
                            ...
                            <form action="{{ route('todo.change-is-done', $todo->id) }}" method="POST" class="flex ml-2">
                                ...
                                <button href="{{ route('todo.destroy', $todo->id) }}" class="inline-block px-2 py-1 {{ $todo->is_done ? 'bg-blue-900' : 'bg-blue-600' }} text-white  text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
